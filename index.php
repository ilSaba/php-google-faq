...
<header>
    <div class="left">
        <img src="https://www.salvatorepumo.it/wp-content/uploads/2020/07/logo-google-01.png" alt="">
...
<main>
<?php
    foreach ($varContain as $question => $answer) { ?>
        <h2><?= $question ?></h2>
        <p><?= $answer ?></p>
    <?php
    }
...
<footer>
    ...
    <div class="select">
        ...
        <option value="saab">Russo</option>
